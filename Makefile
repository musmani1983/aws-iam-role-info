...
# Target to run the Python script within the virtual environment (CSV format)
run-csv: setup
	$(VENV_DIR)/bin/python $(SCRIPT) --format csv

# Target to run the Python script within the virtual environment (JSON format)
run-json: setup
...
help:
	...
	@echo ""
	@echo "To run the script, you can use 'make run-csv' or 'make run-json'."
